...
import 'package:slc/pages/display_manager_page.dart';
...
import 'package:slc/utils/widgets/text_field_wrapper.dart';
      ...
      body: SettingsList(
        sections: [
          ...
          SettingsSection(title: const Text('版本号'), tiles: <SettingsTile>[
            SettingsTile(
              title: const Text(ApplicationInfo.currentVersion),
